...
banner:
  ...
  bg_overlay: true
  title: "Accelerating experiments and testing around the world"
  content: "We engineer precision so you can focus on your work. Leave the hardware to us."
  button:
    enable: true
...
**Founded by two engineers from different disciplines,** HF Labs is driven by a shared obsession: to build elegant, robust instruments that scientists *actually enjoy using*. We know how hard experiments are already—your tools shouldn’t be the bottleneck.

**We don’t cut corners. We sweat the details. We build things the way we wish they had been built for us.**"
  image: "HF_images/products/OPM/PCB1.png"
